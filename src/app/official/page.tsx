  ...
  return (
    <main className="min-h-screen bg-[#f5f8fc] text-[#10233f] bc-page-enter">
      <div className="mx-auto max-w-[1440px] px-4 py-4 sm:px-6 lg:px-8">
        <header className="flex flex-wrap items-center justify-between gap-4 rounded-2xl border border-[#dce6f0] bg-white bc-panel px-5 py-4 shadow-sm"><div><p className="text-xs font-bold uppercase tracking-widest text-[#0b66c3]">BConnect Operations</p><h1 className="mt-1 text-xl font-extrabold tracking-tight">Barangay Operations</h1></div><div className="flex items-center gap-2"><span className="hidden rounded-full bg-emerald-50 px-3 py-2 text-xs font-bold text-emerald-700 sm:inline-flex">● Live</span><button onClick={() => loadIncidents().catch((e) => setError(e instanceof Error ? e.message : 'Refresh failed.'))} className="rounded-xl border border-slate-200 px-4 py-2.5 text-sm font-bold text-slate-700 hover:bg-slate-50">Refresh</button><Link href="/resident" className="rounded-xl bg-[#0b66c3] px-4 py-2.5 text-sm font-bold text-white hover:bg-[#075aa9]">Resident view</Link></div></header>
