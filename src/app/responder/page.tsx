      ...
      <div className="mx-auto max-w-6xl px-4 py-5 sm:px-6 sm:py-7 lg:px-8">
        <header className="flex flex-wrap items-center justify-between gap-4 border-b border-slate-200 pb-5">
          <Link href="/" className="rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2">
            <p className="text-base font-bold tracking-tight text-slate-950">BConnect</p>
            <p className="text-xs font-medium text-slate-500">Responder workspace</p>
          </Link>
          <div className="flex items-center gap-3">
            <div className="text-right">
              <p className="text-[11px] font-semibold uppercase tracking-[0.12em] text-slate-400">Duty status</p>
        ...
        {availabilityError && <div role="alert" className="mt-4 rounded-2xl border border-amber-200 bg-amber-50 p-3 text-xs leading-5 text-amber-800">{availabilityError}</div>}

        <section className="mt-7 overflow-hidden rounded-3xl bg-slate-950 p-6 text-white shadow-xl shadow-slate-200/60 sm:p-8">
          <div className="flex flex-col justify-between gap-6 sm:flex-row sm:items-end">
            <div>
              <div className="inline-flex rounded-full border border-white/10 bg-white/10 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.14em] text-slate-300">Live operations</div>
